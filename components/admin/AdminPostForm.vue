<template>
  <form class="real-form w-2/3" @submit.prevent="onSave">
    <h1 class="text-2xl text-center mt-10 mb-3">Create Post</h1>
    <div class="flex flex-col">
      ...
      <AppButton btn-style="save" type="submit">Save</AppButton>
